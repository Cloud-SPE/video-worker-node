...
- `http-api.md` — HTTP surface: `/health`, `/capabilities`, `POST /v1/video/transcode`, `POST /v1/video/transcode/abr`, `POST /stream/start`, `POST /stream/stop`. Request/response schemas, error codes, header conventions.
