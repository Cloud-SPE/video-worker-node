...
- **Payment contract** — consumes `livepeer-payment-daemon v4.0.1` payee sessions (`OpenSession`, sender sealing on first `ProcessPayment`, wire-level `debit_seq`, terminal `CloseSession`).
